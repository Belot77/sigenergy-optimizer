...
- Bumped add-on and app version surfaces to 2.3.11-haos22 for advisory export value gate UI card, PV-surplus carve-out, and PV-surplus initiation rollout consistency.
