...
async def get_status(request: Request) -> dict[str, Any]:
    ...
    return {
        ...
        "protected_reserve_soc": d.protected_reserve_soc if d else None,
        "export_surplus_soc": d.export_surplus_soc if d else None,
        "stored_energy_value_floor": d.stored_energy_value_floor if d else None,
        ...
        "pv_surplus_initiation_source": trace_values.get("pv_surplus_initiation_source") if d else None,
        "pv_surplus_estimated_init_reason": trace_values.get("pv_surplus_estimated_init_reason") if d else None,
        "pv_surplus_probe_export_cap_kw": trace_values.get("pv_surplus_probe_export_cap_kw") if d else None,
        "export_value_gate_pv_surplus_kw": trace_values.get("export_value_gate_pv_surplus_kw") if d else None,
        "today_import_topup_kwh": trace_values.get("today_import_topup_kwh") if d else None,
        "today_highest_actual_import_price": trace_values.get("today_highest_actual_import_price") if d else None,
        "import_cost_export_floor": trace_values.get("import_cost_export_floor") if d else None,
        "effective_battery_export_floor": trace_values.get("effective_battery_export_floor") if d else None,
        "actual_import_cost_guard_reason": trace_values.get("actual_import_cost_guard_reason") if d else None,
        "topoff_target_soc": trace_values.get("topoff_target_soc") if d else None,
        "battery_discharge_kw_for_pv_only": trace_values.get("battery_discharge_kw_for_pv_only") if d else None,
        "battery_flow_source_for_pv_only": trace_values.get("battery_flow_source_for_pv_only") if d else None,
        "solar_potential_kw": trace_values.get("solar_potential_kw") if d else None,
        ...
        "pv_surplus_export_allowed_below_import_floor": trace_gates.get("pv_surplus_export_allowed_below_import_floor") if d else None,
        "pv_surplus_only_proven": trace_gates.get("pv_surplus_only_proven") if d else None,
        "pv_surplus_estimated_init_enabled": trace_gates.get("pv_surplus_estimated_init_enabled") if d else None,
        "pv_surplus_estimated_init_active": trace_gates.get("pv_surplus_estimated_init_active") if d else None,
        "pv_surplus_topoff_block_active": trace_gates.get("pv_surplus_topoff_block_active") if d else None,
        "topoff_target_met": trace_gates.get("topoff_target_met") if d else None,
        "import_cost_floor_trusted": trace_gates.get("import_cost_floor_trusted") if d else None,
        "import_cost_floor_unknown": trace_gates.get("import_cost_floor_unknown") if d else None,
        "import_cost_floor_block_active": trace_gates.get("import_cost_floor_block_active") if d else None,
        "actual_import_cost_guard_active": trace_gates.get("actual_import_cost_guard_active") if d else None,
        "actual_import_cost_guard_blocking": trace_gates.get("actual_import_cost_guard_blocking") if d else None,
        "automatic_export_blocked_below_actual_import_cost": trace_gates.get("automatic_export_blocked_below_actual_import_cost") if d else None,
        "pv_only_discharge_ok": trace_gates.get("pv_only_discharge_ok") if d else None,
        "pv_only_ems_safe": trace_gates.get("pv_only_ems_safe") if d else None,
        "pv_cap_active": trace_gates.get("pv_cap_active") if d else None,
        "pv_cap_reason": trace_values.get("pv_cap_reason") if d else None,
        "current_pv_max_limit_kw": trace_values.get("current_pv_max_limit_kw") if d else None,
        "desired_pv_max_limit_kw": trace_values.get("desired_pv_max_limit_kw") if d else None,
        "normal_pv_max_limit_kw": trace_values.get("normal_pv_max_limit_kw") if d else None,
        "measured_pv_surplus_kw": trace_values.get("measured_pv_surplus_kw") if d else None,
        "estimated_pv_surplus_kw": trace_values.get("estimated_pv_surplus_kw") if d else None,
        "hidden_pv_surplus_kw": trace_values.get("hidden_pv_surplus_kw") if d else None,
        "hidden_pv_possible": trace_gates.get("hidden_pv_possible") if d else None,
        "pv_surplus_trusted_for_export": trace_gates.get("pv_surplus_trusted_for_export") if d else None,
        "curtailment_diagnostic_reason": trace_values.get("curtailment_diagnostic_reason") if d else None,
